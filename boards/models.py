...
class Topic(models.Model):
    ...
    started = models.ForeignKey(User, related_name='topics', on_delete=models.DO_NOTHING)
...
class Post(models.Model):
    ...
    topics = models.ForeignKey(Topic, related_name='posts', on_delete=models.DO_NOTHING)
